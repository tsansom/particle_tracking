...
if 'coords' not in vars():
    ...
    #coords = tbt.read.coords(r'F:/home/tsansom/Projects/Galveston/ptrac2/input', 15)
...
#            ptrac_path = os.path.join(r'F:/home/tsansom/Projects/Galveston/ptrac2/ptrac/{}'.format(p_dir))
...
#    inflow_path = r'F:/home/tsansom/InputData/V201702'
...
#    string = r'T:/baysestuaries/USERS/TSansom/Projects/ptrac2/galv/{}_months_{}_fps.mp4'.format(key, fps)
